...
app.controller('JoinCtrl', ['$scope', '$rootScope', '$state', '$stateParams', '$location', '$filter', '$log', 'Topic', function ($scope, $rootScope, $state, $stateParams, $location, $filter, $log, Topic) {
