...
angular
    .module('citizenos')
    .controller('LoginSmartIdFormCtrl', ['$scope', '$log', '$state', '$window', '$timeout', '$q', 'ngDialog', 'sLocation', 'sAuth', function ($scope, $log, $state, $window, $timeout, $q, ngDialog, sLocation, sAuth) {
