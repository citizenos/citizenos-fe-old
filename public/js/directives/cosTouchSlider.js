angular
  ...
  function($swipe, $rootScope, $window, $parse) {
    ...
    return {
      restrict: 'EA',
	  /* Do oneway binding for attribute start_slide_at, NOTE camelcase */ 
      scope: {
			startSlideAt: '@',
			identifier: '@',
			class: '@',
      ...
      link: function(scope, element, attrs) {
			...
			function run_me_twice() {
                ...
                console.log(element_max_distance_left)
			...
			$swipe.bind(element, {
			  ...
			  'end': function(coords) {
					...
					elementX_end = Number(element_style.getPropertyValue("margin-left").replace('px', ''));
